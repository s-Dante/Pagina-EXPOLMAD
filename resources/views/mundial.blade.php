...
<head>
    ...
    <style>
        ...
        @keyframes scroll-vertical {
            ...
            100% { transform: translateY(-50%); } /* move up half since content is doubled */
        }

        @keyframes scroll {
            0% { transform: translateX(0); }
            100% { transform: translateX(-50%); } /* move left half since content is doubled */
        }
...
<sponsors>
    <div id="left-sponsor" class="perimeter-board left">
        <div class="scroll-content left">
            <img src="images/cocacola-logo_rotated.jpeg" class="sponsor-logo-vertical" alt="Coca Cola">
            <img src="images/logo_accenture.png" class="sponsor-logo-vertical" alt="Accenture">
            <img src="images/logo_unreal.jpg" class="sponsor-logo-vertical" alt="Unreal">
            <img src="images/cocacola-logo_rotated.jpeg" class="sponsor-logo-vertical" alt="Coca Cola">
            <img src="images/logo_accenture.png" class="sponsor-logo-vertical" alt="Accenture">
            <img src="images/logo_unreal.jpg" class="sponsor-logo-vertical" alt="Unreal">
            <img src="images/cocacola-logo_rotated.jpeg" class="sponsor-logo-vertical" alt="Coca Cola">
    ...
    <div id="top-sponsor" class="perimeter-board top">
        <div class="scroll-content top">
            <img src="images/cocacola-logo.jpeg" class="sponsor-logo-horizontal" alt="Coca Cola">
            <img src="images/cocacola-logo.jpeg" class="sponsor-logo-horizontal" alt="Coca Cola">
            <img src="images/cocacola-logo.jpeg" class="sponsor-logo-horizontal" alt="Coca Cola">
            <img src="images/cocacola-logo.jpeg" class="sponsor-logo-horizontal" alt="Coca Cola">
            <img src="images/cocacola-logo.jpeg" class="sponsor-logo-horizontal" alt="Coca Cola">
...
function resizeCanvas() {
    ...
    console.log("Window aspect ratio:", width / height);
...
async function init() {
    await loadSVGImage("images/Cancha_v2.png").then(img => {
        field.img = img;
        field.init();
    });
    await loadSVGImage("images/Bisonte_v3.svg").then(img => {
        vicente.img = img;
    });
    await loadSVGImage("images/Pelota_v1.svg").then(img => {
        ball.img = img;
    });
